<template>
  <div class="profile-page">
    <div class="profile-container glass-container">
      ...
      <!-- 알림 메시지 -->
      <div v-if="notification.show" :class="['profile-notification', `profile-notification--${notification.type}`]">
...
const saveChanges = async () => {
  ...
  try {
    ...
    const updateData = {
      ...
      nickname: editData.nickname !== userData.value.nickname ? editData.nickname : null,
      email: editData.email !== userData.value.email ? editData.email : null,
      phoneNumber: editData.phoneNumber !== userData.value.phoneNumber ? editData.phoneNumber : null
    }
