<template>
  <div class="post-form">
    <div class="post-form__header glass-card">
      <h1 class="post-form__title">{{ isEditing ? '게시글 수정' : '게시글 작성' }}</h1>
      <div class="post-form__actions">
        <AppButton 
          ...
          class="back-btn"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="post-form__icon">
        ...
        <div class="post-form__thumbnail">
          ...
          >
            ...
            <div v-else class="post-form__thumbnail-placeholder">
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="post-form__icon post-form__icon-large">
  ...
  try {
    ...
    if (error.response) {
      ...
      if (status === 401) {
        ...
        notificationStore.showError(isEditing.value ? '게시글 수정에 실패했습니다.' : '게시글 작성에 실패했습니다.')
      }
    } else {
      notificationStore.showError(isEditing.value ? '게시글 수정에 실패했습니다.' : '게시글 작성에 실패했습니다.')
    }
