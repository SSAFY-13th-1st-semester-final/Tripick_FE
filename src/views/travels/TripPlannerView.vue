<template>
  <div class="trip-planner-view">
    ...
    <div class="panels-container">
      <!-- 장소 검색 패널 -->
      <div class="panel search-panel glass-card" :class="{ collapsed: isSearchPanelCollapsed }">
        <div class="panel-header">
          <h3>장소 검색</h3>
          <button class="panel-toggle glass-btn" @click="toggleSearchPanel">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" :class="{ 'rotate-180': isSearchPanelCollapsed }">
      ...
      <!-- 일정 관리 패널 -->
      <div class="panel schedule-panel glass-card" :class="{ collapsed: isSchedulePanelCollapsed }">
        <div class="panel-header">
          <h3>일정 관리</h3>
          <button class="panel-toggle glass-btn" @click="toggleSchedulePanel">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" :class="{ 'rotate-180': !isSchedulePanelCollapsed }">
...
const hasTripInfo = computed(() => {
  return tripInfo.value.title && tripInfo.value.startDate && tripInfo.value.endDate;
});
