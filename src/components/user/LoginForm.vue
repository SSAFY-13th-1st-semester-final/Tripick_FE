  ...
  <div class="login-form">
    ...
    <form @submit.prevent="submitForm" class="login-form__form">
      ...
      <div class="login-form__forgot-password">
        <router-link to="/auth/forgot-password">비밀번호를 잊으셨나요?</router-link>
      </div>
...
onMounted(() => {
  try {
    ...
    if (route.query.registered === 'true') {
      ...
      notificationStore.showSuccess('회원가입이 완료되었습니다. 로그인해주세요.', {
        duration: 4000
      })
      ...
      notificationStore.showWarning('세션이 만료되었습니다. 다시 로그인해주세요.', {
        duration: 5000
      })
    }
  } catch (e) {
