      ...
      <div class="hotel-section">
        ...
        <div v-if="currentDayHotel" class="hotel-item glass-card">
          ...
          <div class="hotel-content">
            ...
            <div class="hotel-address">{{ currentDayHotel.roadAddressName || currentDayHotel.addressName }}</div>
          ...
          <div class="hotel-actions">
            ...
            <div v-if="currentDayHotel.checkOutTime" class="check-time">
              <span>체크아웃: {{ formatTime(currentDayHotel.checkOutTime) }}</span>
            </div>
...
@media (max-width: $breakpoint-md) {
  ...
  .place-content, .hotel-content {
    width: 100%;
    margin-bottom: $spacing-sm;
  }
  
  .place-actions, .hotel-actions {
    width: 100%;
    flex-direction: row;
    align-items: center;
